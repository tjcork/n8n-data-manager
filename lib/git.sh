...
# Git operations module for n8n-manager
...
init_git_repo() {
    ...
    if [[ ! -d ".git" ]]; then
        ...
        echo "# n8n Backup Repository" > README.md
        echo "" >> README.md
        echo "This repository contains automated backups of n8n workflows and credentials." >> README.md
        echo "Generated by n8n-manager on $(date)" >> README.md
